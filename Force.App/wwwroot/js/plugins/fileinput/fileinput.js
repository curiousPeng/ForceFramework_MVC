...
(function ($) {
    ...
    $.fn.fileinput.locales.en = {
        ...
        uploadLabel: '上传',
        uploadTitle: '上传选中的文件',
        msgSizeTooLarge: '文件 "{name}" (<b>{size} KB</b>) 大小超出了 <b>{maxSize} KB</b>. 请重新选择上传',
        msgFilesTooLess: '您选择的文件不能少于 <b>{n}</b> {files} 上传. 请重新选择上传',
        msgFilesTooMany: '文件上传数量 <b>({n})</b> 超过了限制的 <b>{m}</b>. 请重新选择上传',
        msgFileNotFound: '文件 "{name}" 没找到',
        msgFileSecured: '没有权限获取文件 "{name}".',
        msgFileNotReadable: '文件 "{name}" 不可读.',
        msgFilePreviewAborted: '文件"{name}"预览失败.',
        msgFilePreviewError: '读取文件 "{name}"是发生错误.',
        msgInvalidFileType: '文件 "{name}"类型无效. 只有 "{types}" 文件才可上传.',
        msgInvalidFileExtension: '文件 "{name}"是无效的扩展. 只有 "{extensions}" 才可上传.',
        msgValidationError: '上传失败',
        msgLoading: 'Loading file {index} of {files} &hellip;',
        msgProgress: 'Loading file {index} of {files} - {name} - {percent}% completed.',
        msgSelected: '选中{n}个文件',
        msgFoldersNotAllowed: '只能单个文件拖动! {n} 个文件拖动失败.',
        dropZoneTitle: '预览区域'
    };
